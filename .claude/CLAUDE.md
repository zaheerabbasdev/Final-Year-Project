...
```
NEXT_PUBLIC_API_URL=http://academy-dev-alb-1956712506.ap-south-1.elb.amazonaws.com/api
NEXT_PUBLIC_WS_URL=http://academy-dev-alb-1956712506.ap-south-1.elb.amazonaws.com
```

### Flutter (compile-time define)
```
API_BASE_URL=http://academy-dev-alb-1956712506.ap-south-1.elb.amazonaws.com/api
```
...
### ALB
- **Current DNS**: `academy-dev-alb-1956712506.ap-south-1.elb.amazonaws.com`
